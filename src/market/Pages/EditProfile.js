...
function EditProfile({ history }) {
    const [user, setUser] = useState({ firstname: "",lastname:"", phoneNumber: "", email: "", avatar: "" });
                ...
                <div className="container">
                    <form className="col-lg-12">
                        ...
                        <Row className="profile-row">
                            ...
                            <Col lg={4} md={3} sm={12}>
                                <p><BsFillPersonFill /> <input type="text" name="firstname" value={user.firstname} onChange={handleChanges} required /></p>
                                <p><BsFillPersonFill /> <input type="text" name="lastname" value={user.lastname} onChange={handleChanges} required /></p>
